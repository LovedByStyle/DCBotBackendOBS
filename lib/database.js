...
class DatabaseManager {
    ...
    async upsertGroup(groupId, status = 'active') {
        try {
            ...
            logger.error(`upsertGroup error: ${error.message}`);
            throw error;
        }
    }
    ...
    async updateGroupStatus(groupId, status) {
        try {
            ...
            logger.error(`updateGroupStatus error: ${error.message}`);
        }
    }
    ...
    async upsertBot(groupId, dvsaUsername, data = {}) {
        try {
            ...
            logger.error(`upsertBot error: ${error.message}`);
            throw error;
        }
    }
    ...
    async getBot(groupId, dvsaUsername) {
        try {
            ...
            logger.error(`getBot error: ${error.message}`);
            return null;
        }
    }
    ...
    async getBotsByGroup(groupId) {
        try {
            ...
            logger.error(`getBotsByGroup error: ${error.message}`);
            return [];
        }
    }
    ...
    async getAllBots() {
        try {
            ...
            logger.error(`getAllBots error: ${error.message}`);
            return [];
        }
    }
    ...
    async updateBotClicks(groupId, dvsaUsername, clicks) {
        try {
            ...
            logger.error(`updateBotClicks error: ${error.message}`);
        }
    }
    ...
    async incrementButtonClick(groupId, dvsaUsername, buttonType) {
        try {
            ...
            logger.debug(`Incremented ${buttonType} clicks for ${groupId}/${dvsaUsername}`);
        } catch (error) {
            logger.error(`incrementButtonClick error: ${error.message}`);
        }
    }
    ...
    async updateBotStatus(groupId, dvsaUsername, status) {
        try {
            ...
            logger.error(`updateBotStatus error: ${error.message}`);
        }
    }
    ...
    async updateBotHeartbeat(groupId, dvsaUsername) {
        try {
            ...
            logger.error(`updateBotHeartbeat error: ${error.message}`);
        }
    }
    ...
    async logEvent(groupId, dvsaUsername, eventType, message, data = null) {
        try {
            ...
            logger.error(`logEvent error: ${error.message}`);
        }
    }
    ...
    async getRecentLogs(limit = 100) {
        try {
            ...
            logger.error(`getRecentLogs error: ${error.message}`);
            return [];
        }
    }
    ...
    async getGroupLogs(groupId, limit = 50) {
        try {
            ...
            logger.error(`getGroupLogs error: ${error.message}`);
            return [];
        }
    }
    ...
    async recordSlotFound(groupId, dvsaUsername, slotCount = 1) {
        try {
            ...
            logger.error(`recordSlotFound error: ${error.message}`);
        }
    }
    ...
    async markSlotCompleted(groupId, dvsaUsername) {
        try {
            ...
            logger.error(`markSlotCompleted error: ${error.message}`);
        }
    }
    ...
    async getSlotStats() {
        try {
            ...
            logger.error(`getSlotStats error: ${error.message}`);
            return [];
        }
    }
    ...
    async clearOldEvents(daysToKeep = 30) {
        try {
            ...
            logger.info(`Cleared ${result.deletedCount} old events (older than ${daysToKeep} days)`);
            return result.deletedCount;
        } catch (error) {
            logger.error(`clearOldEvents error: ${error.message}`);
            return 0;
        }
    }
    ...
    async clearGroupLogs(groupId) {
        try {
            ...
            logger.info(`Cleared ${result.deletedCount} logs for group ${groupId}`);
            return result.deletedCount;
        } catch (error) {
            logger.error(`clearGroupLogs error: ${error.message}`);
            return 0;
        }
    }
    ...
    async deleteGroup(groupId) {
        try {
            ...
            logger.info(`Deleted group ${groupId}: ${botResult.deletedCount} bots, ${eventResult.deletedCount} events`);
    ...
    async deleteBot(groupId, dvsaUsername) {
        try {
            ...
            logger.info(`Deleted bot ${groupId}/${dvsaUsername}: ${eventResult.deletedCount} events`);
            return { success: true, eventsDeleted: eventResult.deletedCount };
        } catch (error) {
            logger.error(`deleteBot error: ${error.message}`);
            return { success: false, message: error.message };
        }
    }
    ...
    async getCommonSettings() {
        try {
            ...
            logger.error(`getCommonSettings error: ${error.message}`);
            return null;
        }
    }
    ...
    async updateCommonSettings(data) {
        try {
            ...
            logger.error(`updateCommonSettings error: ${error.message}`);
            throw error;
        }
    }
    ...
    async recordClick(accountId, dvsaUsername, buttonType) {
        try {
            ...
            logger.info(`Click recorded for ${dvsaUsername}: ${clickRecord.clicks_today} clicks today`);
            return clickRecord;
            
        } catch (error) {
            logger.error(`recordClick error: ${error.message}`);
            throw error;
        }
    }
    ...
    async getTodayClickStats(accountId) {
        try {
            ...
            logger.error(`getTodayClickStats error: ${error.message}`);
            return {
                clicks_today: 0,
                button_breakdown: {
                    next_available: 0,
    ...
    async getAllAccountsWithClickStats() {
        try {
            ...
            logger.error(`getAllAccountsWithClickStats error: ${error.message}`);
            return [];
        }
    }
    ...
    async cleanupOldClickRecords() {
        try {
            ...
            logger.info(`Cleaned up ${result.deletedCount} old click records`);
            return result.deletedCount;
        } catch (error) {
            logger.error(`cleanupOldClickRecords error: ${error.message}`);
            return 0;
        }
    }
    ...
    async startBotSession(accountId, dvsaUsername) {
        try {
            ...
            await session.save();
            logger.info(`Bot session started for ${dvsaUsername}`);
            return session;
        } catch (error) {
            logger.error(`startBotSession error: ${error.message}`);
            throw error;
        }
    }
    ...
    async endBotSession(accountId, clicksCount = 0) {
        try {
            ...
            if (!session) {
                logger.warn(`No running session found for account ${accountId}`);
                return null;
            }
            ...
            await session.save();
            logger.info(`Bot session ended for ${session.dvsa_username}: ${durationMinutes} minutes, ${clicksCount} clicks`);
            return session;
        } catch (error) {
            logger.error(`endBotSession error: ${error.message}`);
            throw error;
        }
    }
    ...
    async getRunningSession(accountId) {
        try {
            ...
            logger.error(`getRunningSession error: ${error.message}`);
            return null;
        }
    }
